...
class EditMealItemDialog : AppCompatDialogFragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val calories = mealItem?.calories
        ...
        Log.d(TAG, "onCreate: ends, arguments: dialog id $dialogId, food item $mealItem, and calculated factor $factor")
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        okButton.setOnClickListener {
            ...
            if(etAddQuantity.text?.isEmpty()!!) {
                ...
                val changedMealItem = MealPlanItem(mealItem?.id!!, mealItem?.name!!, etAddQuantity.text.toString().toLong(), tvCalories.text.toString().toLong(), mealItem?.category!!, mealItem?.date!!)

                val args = Bundle().apply {
                    putParcelable(EDIT_MEAL_DIALOG_MEAL_ITEM, changedMealItem)
                    putInt(EDIT_MEAL_DIALOG_MEAL_ITEM_POSITION, mealPosition!!)
                }
