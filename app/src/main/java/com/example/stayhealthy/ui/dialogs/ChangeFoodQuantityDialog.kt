...
class ChangeFoodQuantityDialog : AppCompatDialogFragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val quantity = foodItem?.Quantity ?: 0
        ...
        Log.d(
                TAG,
                "onCreate: ends, arguments: dialog id $dialogId, food item $foodItem, and calculated factor $factor"
        )
    ...
    private fun setQuantityInputListener() {
